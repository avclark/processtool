// bm-design-system: tabs primitive
//
// Inline tabs built on Radix Tabs, styled with the design tokens (see `.tabs-list`
// / `.tab-trigger` / `.tab-content` in design-system.css). Usage:
//
